...
alias cp='cp -i'
alias mv='mv -i'
alias rm='rm -I'                    # 'rm -i' prompts for every fil
...
alias sinisa94='ssh sinisa94@sinisa94-pc'
...
[ -r /usr/share/doc/pkgfile/command-not-found.bash ] && source /usr/share/doc/pkgfile/command-not-found.bash #dep: pkgfile
